          ...
          <div className="hero-wrapper">
            <div className="hero">
              ...
              <div className="hero-avatar">
                <img alt={items.profile.user.name} className="avatar-image" src={items.profile.user.provider_pic}
            ...
            <div>
              <div data-react-className="UserFollowContainer"
                ...
                <div data-reactroot="">
                  ...
                  <div>{items.user.name ?
                    <FollowButton user={`${items.user.following}`} to_follow={`${items.profile.user._id}`}/> : ''}</div>
                </div>
              </div>
            ...
            <div className="post-panel">
              ...
              <div className="post-metadata">
                ...
                <div className="post-info">
                  <div className="PopoverLink"><span className="popover-link" data-reactroot=""><a
                    href="javascript:void(0);">{items.profile.user.name}</a></span></div>
                  <small>Pulished • a must read</small>
                </div>
              </div>
                  ...
                  <div className="bookmark-button-wrapper">
                    <form className="button_to" method="get" action="">
                      <button className="bookmark-button" data-behavior="trigger-overlay" type="submit"><span
                        className="icon-bookmark-o"></span><span className="hide-text">Bookmark</span></button>
                    </form>
                  </div>
